...
MOVE @logicalNameD TO 'C:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\Data\$(database).mdf',

MOVE @logicalNameL TO 'C:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\Data\$(database).ldf'
